...
Additional topics for interview prep:
  ...
  [](/donnemartin/system-design-primer/blob/master/images/zdCAkB3.png)
...
Looking for resources to help you prep for the [**Coding Interview**](https://github.com/donnemartin/interactive-coding-challenges)?
  ...
  [](/donnemartin/system-design-primer/blob/master/images/b4YtAEN.png)
...
Each section contains links to more in-depth resources.
  ...
  [](/donnemartin/system-design-primer/blob/master/images/jrUBAF7.png)
  

Suggested topics to review based on your interview timeline (short, medium, long).

[](/donnemartin/system-design-primer/blob/master/images/OfVllex.png)
...
[Solution](/donnemartin/system-design-primer/blob/master/solutions/system_design/pastebin/README.md)

Design the Twitter timeline and search (or Facebook feed and search)
[Solution](/donnemartin/system-design-primer/blob/master/solutions/system_design/twitter/README.md)

Design a web crawler
[Solution](/donnemartin/system-design-primer/blob/master/solutions/system_design/web_crawler/README.md)

Design Mint.com
[Solution](/donnemartin/system-design-primer/blob/master/solutions/system_design/mint/README.md)

Design the data structures for a social network
[Solution](/donnemartin/system-design-primer/blob/master/solutions/system_design/social_graph/README.md)

Design a key-value store for a search engine
[Solution](/donnemartin/system-design-primer/blob/master/solutions/system_design/query_cache/README.md)

Design Amazon's sales ranking by category feature
[Solution](/donnemartin/system-design-primer/blob/master/solutions/system_design/sales_rank/README.md)

Design a system that scales to millions of users on AWS
[Solution](/donnemartin/system-design-primer/blob/master/solutions/system_design/scaling_aws/README.md)
...
[](/donnemartin/system-design-primer/blob/master/images/bWxPtQA.png)

[View exercise and solution](/donnemartin/system-design-primer/blob/master/solutions/system_design/mint/README.md)

[](/donnemartin/system-design-primer/blob/master/images/V5q57vU.png)
### Design the data structures for a social network
[
...
[](/donnemartin/system-design-primer/blob/master/images/cdCv5g7.png)
### Design a key-value store for a search engine
[
...
[](/donnemartin/system-design-primer/blob/master/images/4j99mhe.png)
### Design Amazon's sales ranking by category feature
[

](#design-amazons-sales-ranking-by-category-feature)

[View exercise and solution](/donnemartin/system-design-primer/blob/master/solutions/system_design/sales_rank/README.md)

[](/donnemartin/system-design-primer/blob/master/images/MzExP06.png)
### Design a system that scales to millions of users on AWS
[
...
[
  ...
  [](/donnemartin/system-design-primer/blob/master/images/bgLMI2u.png)
...
If both `Foo` and `Bar` each had 99.9% availability, their total availability in parallel would be 99.9999%.
  ...
  [](/donnemartin/system-design-primer/blob/master/images/IOyLj4i.jpg)
...
[
  ...
  [](/donnemartin/system-design-primer/blob/master/images/h9TAuGI.jpg)
...
[
  ...
  [](/donnemartin/system-design-primer/blob/master/images/h81n9iK.png)
...
[
  ...
  [](/donnemartin/system-design-primer/blob/master/images/n41Azff.png)
...
[
  ...
  [](/donnemartin/system-design-primer/blob/master/images/yB5SYwm.png)
...
[
  ...
  [](/donnemartin/system-design-primer/blob/master/images/Xkm5CXz.png)
...
The master serves reads and writes, replicating writes to one or more slaves, which serve only reads.  Slaves can also replicate to additional slaves in a tree-like fashion.  If the master goes offline, the system can continue to operate in read-only mode until a slave is promoted to a master or a new master is provisioned.
  ...
  [](/donnemartin/system-design-primer/blob/master/images/C9ioGtn.png)
...
Both masters serve reads and writes and coordinate with each other on writes.  If either master goes down, the system can continue to operate with both reads and writes.
  ...
  [](/donnemartin/system-design-primer/blob/master/images/krAHLGg.png)
...
](#sources-and-further-reading-replication)

  [](/donnemartin/system-design-primer/blob/master/images/U3qV33e.png)
...
Source(s) and further reading: federation[
  ...
  [](/donnemartin/system-design-primer/blob/master/images/wU8x5Id.png)
...
](#sources-and-further-reading-denormalization)
...
Source(s) and further reading: document store[
  ...
  [](/donnemartin/system-design-primer/blob/master/images/n16iOGk.png)
...
Source(s) and further reading: wide column store[
  ...
  [](/donnemartin/system-design-primer/blob/master/images/fNcl65g.png)
...
Source(s) and further reading: NoSQL[
  ...
  [](/donnemartin/system-design-primer/blob/master/images/wXGqG5f.png)
...
Source(s) and further reading: SQL or NoSQL[
  ...
  [](/donnemartin/system-design-primer/blob/master/images/Q6z24La.png)
...
Since you can only store a limited amount of data in cache, you'll need to determine which cache update strategy works best for your use case.
  ...
  [](/donnemartin/system-design-primer/blob/master/images/ONjORqk.png)
...
- When a node fails, it is replaced by a new, empty node, increasing latency.
  ...
  [](/donnemartin/system-design-primer/blob/master/images/0vBc0hN.png)
...
Write-behind (write-back)[
  ...
  [](/donnemartin/system-design-primer/blob/master/images/rgSrvjG.png)
...
- It is more complex to implement write-behind than it is to implement cache-aside or write-through.
  ...
  [](/donnemartin/system-design-primer/blob/master/images/kxtjqgE.png)
...
[
  ...
  [](/donnemartin/system-design-primer/blob/master/images/54GYsSx.png)
...
[
  ...
  [](/donnemartin/system-design-primer/blob/master/images/5KeocQs.jpg)
...
[
  ...
  [](/donnemartin/system-design-primer/blob/master/images/JdAsdvG.jpg)
...
[
  ...
  [](/donnemartin/system-design-primer/blob/master/images/yzDrJtA.jpg)
...
[
  ...
  [](/donnemartin/system-design-primer/blob/master/images/iF4Mkb5.png)
...
Articles on how real world systems are designed.
  ...
  [](/donnemartin/system-design-primer/blob/master/images/TcUo2fw.png)
