...
Your GAN server is available at [http://localhost:5000/](http://localhost:5000/)
...
Your frontend is available at [http://localhost:8888/](http://localhost:8888/)
...
Your frontend is available at [http://localhost:8888/](http://localhost:8888/), backend at [http://localhost:5000/](http://localhost:5000/).
